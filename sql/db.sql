...
insert into posts (autorId, titulo, conteudo)
values
...
“Incrivelmente atual e original, Garra derruba os preconceitos sobre quão longe nosso potencial pode nos levar. Leia o livro, compre para seus amigos e espalhe a mensagem de que há esperança: todos nós podemos brilhar.”Susan Cain, autora de O poder dos quietos'),
...
Raymond Warren, gestor de mídias sociais e digitais da Cadillac'),
...
(Mark Zuckerberg, cofundador e diretor executivo do Facebook)'),
...
"Repensa o que motiva as pessoas." — Newsweek'),
